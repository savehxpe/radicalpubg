...
const mockSongs: Song[] = [
    {
        ...
        createdAt: new Date(),
        coverArt: "https://lh3.googleusercontent.com/aida-public/AB6AXuAdYe4h5uk8sUsq4uNsYP-D4rxqAVFwViuDQTnJ1pdz3pN8Cs-FVGDBl3YOMpzklRMyFUBP8MMEkJrJKaz6Egv3qUvyjVh_Yi_BBIJB5w0ljo31FBjgOfMqUTterN771J1NPe5nhUPxadkLIcVS7aiGGXRU87K6nq2Se4KbHaVu1t8P8BHcJCS6cKfA2QjfwqbFHworNkVcHbDdT7FsfhkZDfGUPNvGYb6XfUtfu0Y9D534InHwXiIysBblwoYRXanIDyWqvxgtXjE"
    },
    {
        id: "s2",
        title: "MASCOT",
        ...
        createdAt: new Date(),
        coverArt: "https://lh3.googleusercontent.com/aida-public/AB6AXuCTY41RZj_a5-_FEmvyY6mBhCtdvIj9zNzKRiTyHVQLgjzYKQNxeibwlXTod68tgS7JXTvxzf9V_2qysBs2UseCNXwH4-FAafjoUwL666fnoFvzA20b3VbEePEzNcqu9ko9Y3mYILtyHXBR9mSlWROyazPpQelLG0IuS45QLU4U24whmLnkzGN2xgp1WPRWtEo4PQzzaPmvofpsAhytDu65yc5yZdMDanwBxQbKVDHR0vThiExags-o18yA6IMF9CDWroNgCJqvFMo"
    },
    {
        id: "s3",
        ...
        createdAt: new Date(),
        coverArt: "https://lh3.googleusercontent.com/aida-public/AB6AXuBmMpcWxF6I9DUJBAPvND_aGvI3-4YcygrrdIlQMgO9p0eBUZR39Yr6bTWRQK0uQb-gC-bWH_5m4UVFNLxdsPZzJq_pCQaEmyyJtdMFoOOu42XE0v1rMmLmRVWVyAP8ojCT2rmn2RiQFYORq75_NSh5vUiGjms-ooP8RLiGvbRd6gK36fW0ez6NsOjXkkPUUfuNIC32uh56SWk6jmI9n8bkExNOjznMePyU-T0enj5v0eqqrFArPU-si0XUTEIctwBAenQnaNC97j8"
    },
    {
        id: "s4",
        title: "CORE ARCHIVES",
        ...
        createdAt: new Date(),
        coverArt: "https://lh3.googleusercontent.com/aida-public/AB6AXuABMHIYtz_aNytgGb4JjPBDLXbYlFYFP9vLgDU1PGavocW72fML-C3L5LLIHyLStkYUn0gkBlyErWWTgjBgwKLzRggDkQbFHD23Ssfl4rNGnrrfXxHo30rQdy4F_m1eV7FGpfQ9qofmHDMdUPr5gNLIrDL0PYITZOlnlZxFbs8W8gSP8ddFhnWswqILLIxao1AwO92aZIuTWO2_H2dxWbVTggRCsV4cwTu7monot3xGbf2HCWJxxB4MBA4oXbmHuMLMSjgvptH6yZc"
    }
];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 perspective-grid">
                    {catalog.map((item, i) => (
                        <motion.div
                            ...
                            className="group relative rounded-xl glass-panel border border-primary/20 hover:shadow-[0_20px_40px_-20px_rgba(0,255,255,0.4)] transition-colors duration-500"
                        >
                            ...
                            <div className="absolute bottom-0 left-0 p-6 w-full" style={{ transform: "translateZ(50px)" }}>
                                <div className="flex justify-between items-end">
                                    <div>
                                        <p className="text-primary text-[10px] font-mono mb-1">{item.song.genre}</p>
